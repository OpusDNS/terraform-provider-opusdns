...
- **New resource `opusdns_organization_ip_restriction`** — manage organization-level IP allow/deny restrictions, with matching `opusdns_organization_ip_restriction` and `opusdns_organization_ip_restrictions` data sources.
